export { Get{Entity}RepositoryResult } from "@core/domain/{entity-folder}/repository/result/Get{Entity}RepositoryResult";
export { Get{Entity}sRepositoryResult } from "@core/domain/{entity-folder}/repository/result/Get{Entity}sRepositoryResult";
